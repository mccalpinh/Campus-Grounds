...
app.post('/updateordelete', (req, res) => {
  ...
  db.collection(productTable).update(
    ...
    {$set: {productName: req.body.productName, quantity: req.body.quantity, flavor: req.body.flavor, vendor: req.body.vendor, beginninginventory: req.body.beginninginventory, purchaseunit: req.body.purchaseunit, inventoryunit1: req.body.inventoryunit1, inventoryunit2: req.body.inventoryunit2}}
    , (result) => {
